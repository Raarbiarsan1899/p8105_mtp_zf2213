...
The p-value of correlation of total activities over time is `r round(stats_day_total$coefficients[2, 4], 6)`. So at 0.01 significance level, we have enough evidence to reject the null hypothesis and conclude that the patient became more active over time.
...
Regarding the data, there seem to be some blackout days, which means the accelerometers did not record anything, and some days with extremely low variance. Refer to supplementary material for more information.
