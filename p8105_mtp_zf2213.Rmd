...
The patient seems to be most active during Fridays and Sundays, and least during Tuesdays, according to the boxplot in Figure.2.

The increases of active during Friday, Saturday and Sunday over time are more significant that that of other days in the week. But the trends are the same for each day in the week.
...
The patient are active during days and sedatory during night. He seems to live a regular life, and slightly more active during night than days.

Regarding the data, there seem to be some missing days (as mentioned in Figure.1), and some "strange" days with extremely low variance. Refer to supplementary material for more information.
...
To summarize, the accelerometer data provides observations of daily activity of a patient. Wrangling more sophisticated information from this dataset requires more advanced statistical learning knowledge and programming skills.
